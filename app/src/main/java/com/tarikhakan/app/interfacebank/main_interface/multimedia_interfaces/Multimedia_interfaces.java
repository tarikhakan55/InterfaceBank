package com.tarikhakan.app.interfacebank.main_interface.multimedia_interfaces;
...
public class Multimedia_interfaces extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try
        {
            ...
            Bitmap BIntarfaceLogo = getBitmapFromAssets("main_interface/multimedia_interfaces/musictheme1.png");
            IntarfaceLogo.setImageBitmap(BIntarfaceLogo);

            goGithub.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/tarikhakan55/InterfaceBank/blob/ccff0536214a6eb906ec4ea8c0671af6906b428e/app/src/main/assets/main_interface/multimedia_interfaces/interfaces/interface_1/Interface%201%20Sources"));
