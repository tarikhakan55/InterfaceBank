package com.tarikhakan.app.interfacebank.widget_interface.weather_interfaces;
...
import com.tarikhakan.app.interfacebank.widget_interface.weather_interfaces.interfaces.interface_1.Interface_1;

import java.io.IOException;
import java.io.InputStream;

public class Weather_interfaces extends AppCompatActivity {

    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_weather_interfaces);
        ...
        try
        {
            ...
            Bitmap BIntarfaceLogo = getBitmapFromAssets("widget_interface/weather_interfaces/weathertheme1.png");
            IntarfaceLogo.setImageBitmap(BIntarfaceLogo);

            goGithub.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/tarikhakan55/InterfaceBank/blob/master/app/src/main/assets/widget_interface/weather_interfaces/interfaces/interface_1/weather%20interface%201%20%20source"));
            ...
            goPage.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Weather_interfaces.this,Interface_1.class);
